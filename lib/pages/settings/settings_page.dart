                    ...
                    new Container(
                      child: new Column(
                        children: <Widget>[
                          ...
                          new ListTile(
                            title: new Text("Gender", style: TextStyle(fontSize: 16.0, color: currTextColor)),
                            trailing: new Text(currUser.gender, style: TextStyle(fontSize: 16.0, color: currTextColor)),
                          ),
                          new ListTile(
